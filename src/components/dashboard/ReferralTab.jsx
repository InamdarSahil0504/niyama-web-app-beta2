    ...
    <div>
      ...
      {isFree && (
        <div style={{ ...card, background:'#fffbeb', border:'1px solid #fcd34d' }}>
          <p style={{ fontSize:'14px', fontWeight:'700', color:'#92400e', marginBottom:'6px' }}>Upgrade to refer friends</p>
          <p style={{ fontSize:'13px', color:'#78350f', lineHeight:'1.6', marginBottom:'12px' }}>
            Referrals are available on Basic, Plus, and Premium plans. Each confirmed referral adds $2.50 to both your and your friend's monthly reward cap.
          </p>
      ...
      {/* Empty state */}
      {!isFree && referrals.length === 0 && referralCode && (
      ...
      <div style={{ ...card, background:'var(--theme-bg)' }}>
        <p style={{ fontSize:'11px', color:'var(--theme-text-muted)', lineHeight:'1.6' }}>
          Max 20 referrals per year · Max $50 additional cap per year · Paid tier required · Self-referrals not allowed · Niyama Life may terminate the referral program at any time.
        </p>
      </div>
    </div>
  )
